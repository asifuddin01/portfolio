...
Built and validated on public data, with the cohort ID list and the frozen configuration released, so the result can be reproduced from public sources alone.
